...
const InvestmentOpportunities = () => {
  return (
    <div>
      ...
      <h2 className="heading text-center text-4xl my-5">
        Great investment opportunities
      </h2>
      <p className="md:w-1/3 text-center mx-auto">
      ...
      <div class="container mx-auto p-4 grid gap-10 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
